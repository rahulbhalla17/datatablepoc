...
class RoyaltyFailedReport extends StatefulWidget {
  const RoyaltyFailedReport({Key? key}) : super(key: key);

  @override
  _RoyaltyFailedReportState createState() => _RoyaltyFailedReportState();
}

class _RoyaltyFailedReportState extends State<RoyaltyFailedReport> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          title: Text("Royalty Failed Report"),
        ),
        body: Container(
